      ...
      <main>
        ...
        >
          ...
          <div>
            ...
            >
              <FaFileExcel size={18} color="#ffffff" />
        ...
        {stats.total > 0 && (
          <div style={{ marginBottom: '20px', backgroundColor: '#0f172a', padding: '10px 14px', borderRadius: '8px', border: '1px solid #334155' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11.5px', color: '#94a3b8', marginBottom: '6px' }}>
              <span>Distribución Porcentual del Periodo:</span>
              <span>
        ...
        <div className="div-buscar" style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '18px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <label style={{ fontSize: '12.5px', fontWeight: '700', color: '#cbd5e1', margin: 0 }}>
              <FaHospital style={{ marginRight: '4px' }} /> IPS:
            </label>
            <select
              value={filtroIps}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <label style={{ fontSize: '12.5px', fontWeight: '700', color: '#cbd5e1', margin: 0 }}>
              <FaCalendarAlt style={{ marginRight: '4px' }} /> Año:
            </label>
            <select
              value={filtroAnio}
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '60px', color: '#94a3b8', fontSize: '16px' }}>
            <FaSync className="fa-spin" style={{ marginRight: '8px' }} /> Consolidando datos de informes...
          </div>
        ) : (
          <div>
                    ...
                    paginatedReportes.map(function (item) {
                      return (
                        <tr key={item._id}>
                          ...
                          <td>
                            <span style={{ color: '#86efac', fontSize: '11.5px', fontWeight: '600' }}>
