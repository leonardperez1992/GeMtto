...
export const apiEditIps = apiIps + '/editips';
export const apiDeleteIps = apiIps + '/deleteips';
export const apiUploadDocIps = apiIps + '/upload-documento';
export const apiDeleteDocIps = apiIps + '/delete-documento';
export const apiVerDocIps = apiIps + '/ver-documento';
export const apiAddEnlaceDriveIps = apiIps + '/add-enlace-drive';
export const apiDeleteEnlaceDriveIps = apiIps + '/delete-enlace-drive';
